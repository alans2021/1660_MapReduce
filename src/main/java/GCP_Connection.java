...
public class GCP_Connection {
    ...
    private final int OUTPUT_STRING_LENGTH = 8;

    public GCP_Connection(String[] f){
        directoryList = f;
    ...
    public void quickstart(
        ...
        try {
            ...
            // The client only needs to be created once and can be reused for multiple requests.
            ...
            for (int i = 0; i < directoryList.length; i++) {
                ...
                String output = String.format("%s/output%s", storageBucket, directory.hashCode());

                //Create Hadoop Job with arguments
